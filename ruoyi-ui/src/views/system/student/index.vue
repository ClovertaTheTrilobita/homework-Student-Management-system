    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="逻辑删除" prop="isDel">
        <el-select v-model="queryParams.isDel" placeholder="请选择逻辑删除" clearable>
          <el-option v-for="dict in dict.type.stu_is_del" :key="dict.value" :label="dict.label" :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item label="所属班级" prop="classId">
        <el-select v-model="queryParams.classId" placeholder="请选择班级" clearable>
          <el-option v-for="stuclass in classList" :key="stuclass.id" :label="stuclass.name" :value="stuclass.id" />
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="逻辑删除" align="center" prop="isDel">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.stu_is_del" :value="scope.row.isDel" />
        </template>
      </el-table-column>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="逻辑删除" prop="isDel">
          <el-select v-model="form.isDel" placeholder="请选择逻辑删除">
            <el-option v-for="dict in dict.type.stu_is_del" :key="dict.value" :label="dict.label"
        ...
        <el-form-item label="所属班级" prop="classId">
          <el-select v-model="form.classId" placeholder="请选择班级">
            <el-option v-for="stuclass in classList" :key="stuclass.id" :label="stuclass.name"
...
import { listClass, getClass } from "@/api/system/class";
